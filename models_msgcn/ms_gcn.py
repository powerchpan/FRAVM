...
import copy
from models_msgcn.net_utils.tgcn import ConvTemporalGraphical
from models_msgcn.net_utils.graph import Graph
...
class Model(nn.Module):
    ...
    def __init__(self, in_channels=3, num_class=6, dil=[1,2,4,8,16], filters=64,
                 edge_importance_weighting=True, **kwargs):
        super(Model, self).__init__()
        graph_args = {'layout': 'sail', 'strategy': 'spatial'}
        # load graph
        # print('--------')
