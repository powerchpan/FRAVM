...
if __name__ == '__main__':
    #data_dir = '/home/user/sail/ori_videos/'
    data_dir = '/home/user/ply/data/five_sts/video/hospital_20230410/front/good/'
    i = 145
    while i<163:
        if((i==22)|(i==23)|(i==60)|(i==74)|(i==77)|(i==85)|(i==87)|(i==102)|(i==114)|(i==115)|(i==117)|(i==118)|(i==143)|(i==147)):
            i+=1
            continue
        vid_file = data_dir+'cs-front-'+str(i)+'.mp4'
        parser = argparse.ArgumentParser()
        #out_dir = '/home/user/ply/data/sail/keypoints_3d/'
        out_dir = '/home/user/ply/data/five_sts/keypoints_3d/hospital_20230410/front_good'
    

        parser.add_argument('--vid_file', type=str,default=vid_file,
                        help='input video path or youtube link')

        parser.add_argument('--output_folder', type=str, default=out_dir,
