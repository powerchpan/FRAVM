...
if __name__ == '__main__':
    ...
    data_dir = '/home/user/ply/data/five_sts/video/hospital_20230410/side/good/'
    i = 1
    while i<163:
        if((i==12)|(i==14)|(i==21)|(i==23)|(i==58)|(i==60)|(i==76)|(i==77)|(i==85)|(i==86)|(i==87)|(i==91)|(i==96)|(i==102)|(i==117)|(i==140)|(i==142)|(i==147)):
            i+=1
            continue
        vid_file = data_dir+'cs-side-'+str(i)+'.mp4'
        parser = argparse.ArgumentParser()
        #out_dir = '/home/user/ply/data/sail/keypoints_3d/'
        out_dir = '/home/user/ply/data/five_sts/keypoints_3d/hospital_20230410/side_good'
